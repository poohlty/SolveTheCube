...
@interface SCAlgorithmViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *row = [[NSString alloc] initWithFormat:@"%u",indexPath.row + 1];
    cell.textLabel.text = self.listData[row];
    cell.textLabel.adjustsFontSizeToFitWidth = YES;
    
    NSString *gifname =  [NSString stringWithFormat:@"%@-%@%@",algorithmType, row, @".gif"];
    cell.imageView.image = [UIImage imageNamed:gifname];
